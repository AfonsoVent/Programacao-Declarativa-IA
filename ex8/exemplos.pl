...
% estado_final([sobre(b,c), livre(a), sobre(a,b), chao(c)]).
...
accao(afectar_r(R1, R2), [valor(R1, V1), valor(R2, V2)], [valor(R1, V2)], [valor(R1, V1)]) :- member(R1, [a, b, c, e, d]), member(V1, [va, vb, vc, ve, vd]), member(R2, [a, b, c, e, d]), member(V2, [va, vb, vc, ve, vd]).
