% Estado inicial
estado_inicial(e([  v(c((2, 4)), [1, 2, 3, 4, 5, 6, 7, 8, 9], _),
...
condicoes(Inst):-
    linha(Inst, 2, 2, 13);      % A soma da 2ª linha tem que ter 2 valores e tem que dar 13. 
    linha(Inst, 3, 4, 24);      % A soma da 3ª linha tem que ter 4 valores e tem que dar 24. 
    linha(Inst, 4, 3, 23);      % A soma da 4ª linha tem que ter 3 valores e tem que dar 23. 
    linha(Inst, 5, 2, 11);      % A soma da 5ª linha tem que ter 2 valores e tem que dar 11. 
    coluna(Inst, 2, 3, 23);      % A soma da 2ª coluna tem que ter 3 valores e tem que dar 23. 
    coluna(Inst, 3, 3, 9);       % A soma da 3ª coluna tem que ter 3 valores e tem que dar 9. 
    coluna(Inst, 4, 3, 24);      % A soma da 4ª coluna tem que ter 3 valores e tem que dar 24. 
    coluna(Inst, 5, 2, 15).      % A soma da 5ª coluna tem que ter 2 valores e tem que dar 15.
