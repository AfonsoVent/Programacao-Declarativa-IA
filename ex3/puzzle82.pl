...
distManh([],[],Dc,Dc).
distManh([b-(_X,_Y)|R],[b-(_W,_Z)|S],Dc,Df):- distManh(R,S,Dc,Df). 
...
testa2(E0,E1,D):-estado_inicial(E0),op(E0,_Op,E1,_C), h1(E0,D).
testa3(E0,E1,D):-estado_inicial(E0),op(E0,_Op,E1,_C), h2(E0,D).
